...
STATIVE_VERBS = _coconut.set(("suit", "resemble", "assume", "care", "hear", "see", "mean", "like", "desire", "include", "sound", "remain", "wish", "involve", "have", "feel", "forget", "notice", "own", "suppose", "enjoy", "know", "remember", "doubt", "concern", "become", "lack", "understand", "imagine", "exist", "smell", "dislike", "believe", "appreciate", "want", "recognise", "possess", "hate", "taste", "appear", "contain", "adore", "fit", "seem", "realise", "matter", "need", "prefer", "love", "despise",))  # type: Final[set[str]]  #5: STATIVE_VERBS: Final[set[str]] = {
if "__annotations__" not in _coconut.locals():  #5: STATIVE_VERBS: Final[set[str]] = {
    __annotations__ = {}  # type: ignore  #5: STATIVE_VERBS: Final[set[str]] = {
__annotations__["STATIVE_VERBS"] = 'Final[set[str]]'  #5: STATIVE_VERBS: Final[set[str]] = {
