...
if sys.version_info >= (3, 10):
    ...
    from .._compat.py38.accido.class_adjective import Adjective as Adjective
    from .._compat.py38.accido.class_noun import Noun as Noun
    from .._compat.py38.accido.class_verb import Verb as Verb
