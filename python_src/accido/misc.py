...
def index_from_value(input_dict: Union[dict[Any, Any], frozendict[Any, Any]], value: Any) -> int:
    return list(input_dict.values()).index(value)


def key_from_value(dd: Union[dict[Any, Any], frozendict[Any, Any]], value: Any) -> Any:
