...
def find_noun_inflections(
    ...
    if components.case in {"nominative", "vocative", "accusative"}:
        return base_forms

    if components.case == "genitive":
