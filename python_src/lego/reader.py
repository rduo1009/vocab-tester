...
if sys.version_info >= (3, 10):
    ...
    from .._compat.py38.lego.reader import (
        _generate_meaning as _generate_meaning,
    )
    from .._compat.py38.lego.reader import _parse_line as _parse_line
    from .._compat.py38.lego.reader import read_vocab_file as read_vocab_file
