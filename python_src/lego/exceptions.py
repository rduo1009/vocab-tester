...
class InvalidVocabFileFormatError(Exception):  #4: class InvalidVocabFileFormatError(Exception):
    """An error that is raised when a vocab file has the incorrect format."""  #5:     """An error that is raised when a vocab file has the incorrect format."""


_coconut_call_set_names(InvalidVocabFileFormatError)  #8: class InvalidVocabDumpError(Exception):
class InvalidVocabDumpError(Exception):  #8: class InvalidVocabDumpError(Exception):
