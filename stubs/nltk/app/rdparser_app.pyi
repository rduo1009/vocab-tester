...
class RecursiveDescentApp:
    ...
    def autostep(self, *e: Incomplete) -> None: ...
    def cancel_autostep(self, *e: Incomplete) -> None: ...
    def step(self, *e: Incomplete) -> None: ...
    def match(self, *e: Incomplete) -> None: ...
    def expand(self, *e: Incomplete) -> None: ...
    def backtrack(self, *e: Incomplete) -> None: ...
